...
csl_data_path = "/home/heliy2/lab/data/CSL/color/"
# csl_data_path = "/remote-home/cs_cs_heli/data/CSL_video/"
output_folder = "/home/heliy2/lab/data/CSL_frame"  # 输出图片保存文件夹
...
for file in files_list:
    ...
    video_i = [os.path.join(file, i) for i in os.listdir(file)]
    video_list = sorted(video_i)
    for video in video_list:

        video_output = os.path.join(output_folder, f"video{video_count}")
        # video_output = os.path.join(output_folder, f"{video_count}")
        # print(video_output)
